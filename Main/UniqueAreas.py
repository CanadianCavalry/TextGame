...
it flashes on and off periodically.","light,bulb,lightbulb,lamp"))
        self.addFeature(StandardFeatures.UnlockedContainer("It's closed. The door to the closet is so dilapidated it's almost falling off the hinges. \
Why is everything in your room in such awful shape?", "closet", "The door is jammed on its track, but after a strong shove it grudgingly slides open.", "With a little effort, you force the door closed."))
...
so close to your bed it's actually touching the frame. On it you see a scalpal, pliers, fish hooks, a trephine and a long, serrated metal wire.", "table,metal table")
    ...
    #Items
        table201.addItem(UniqueItems.Scalpel201())
